...
const L = {
  ...
  ready: ['ready', 'तैयार'],
  coachingMute: ['Coaching mute', 'सलाह म्यूट'],
  coachingMuted: ['Coaching muted', 'सलाह म्यूट है'],
  coachingMuteHint: ['Mutes everything except safety alerts', 'सुरक्षा चेतावनी के अलावा सब म्यूट'],
